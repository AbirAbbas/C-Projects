 ...
 *@param value that needs to be converted into the key without % modification
 *@return returns key without % division
 **/
...
/**Function to return pointer to dataFile type struct
 *@pre value cannot be null
 *@param value being inserted
 *@return returns pointer to the created dataFile
 **/
